...
- **Part 1 (LLM Schema):** LLM prompt + generated SQL schema screenshot in `docs/llm-schema.png`.
- **Part 2 (Division of Work):**
  - Student A: Front-end (Lovable) — created registration form, integrated Supabase.
  - Student B: Backend (Supabase) — created tables, inserted sample data, provided API keys (not committed).
- **Part 3 (Git workflow):**
